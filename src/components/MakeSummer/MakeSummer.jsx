          ...
          <form className={s.container} onSubmit={handleSubmit}>
            ...
            <div className={s.fg}>
              ...
              <Field
                ...
                component="input"
                type="text"
                placeholder="Умение расставлять приоритеты. Умение
работать в команде. и т.д."
            ...
            <div className={s.fg}>
              ...
              <Field
                ...
                component="input"
                type="text"
                placeholder="Дагестанский государсвенный университет"
              />
            </div>
            <div className={s.fg}>
              ...
              <Field
                className={s.form6}
                name="Ключевые навоки"
                component="input"
                type="text"
                placeholder="IT - студия N"
              />
            </div>
            <div className={s.fg}>
              ...
              <Field
                ...
                component="input"
                type="text"
                placeholder="Опишите подробнее по подробнее про ваш последний
 опыт работы"
              />
            </div>
            <div className={s.fg}>
            ...
            <div className={s.fg}>
              ...
              <Field
                ...
                component="input"
                type="text"
                placeholder="Какие у вас имеются сертификаты , участие в различных
конкурсах и т.д."
              />
            </div>
            <div className={s.fg}>
            ...
            <div className={s.fg}>
              ...
              <Field
                ...
                component="input"
                type="text"
                placeholder="Дополнительные навыки которыми вы обладаете"
              />
            </div>
            <div className={s.fg}>
            ...
            <div className={s.fg}>
              ...
              <Field
                ...
                component="input"
                type="text"
                placeholder="Опишите какие языки вы знаете"
              />
            </div>
            <div className={s.fg}>
              ...
              <Field
                className={s.form6}
                name="Опыт волонтерской или общественной деятельности"
                component="input"
                type="text"
                placeholder="Студенческий специализированный 
...
взгляд», командир отряда"
            ...
            <button className="registration__submit">Опубликовать</button>
          </form>
        )}
      />
    </div>
